...
(
				...
				where ar.policy_id =  '70D41EC4-63D5-11DA-BB34-000E0C7F3ED2' --medicard
							--AND ar.transaction_date_time  BETWEEN '01/01/2016 00:00:00:000' AND '01/01/2017 23:59:59:998'
							 AND ar.transaction_date_time between @From and @To
							 --AND dpr.discount_posting_rule_id in ('05F8582D-6E0D-11E3-A6A2-78E3B597EAF4', '3D06C575-6E0D-11E3-A6A2-78E3B597EAF4') --discount name
